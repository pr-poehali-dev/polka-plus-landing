  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="p-4 border-t border-slate-100 space-y-2">
        ...
        <a href="/safety" className="flex items-center gap-2 w-full px-4 py-2.5 rounded-xl text-sm font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 transition-colors">
          <Icon name="ShieldCheck" size={15} /> Охрана труда
        </a>
